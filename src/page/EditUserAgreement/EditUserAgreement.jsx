...
import { useGetAllUserAgreementQuery, useUpdateUserAgreementMutation } from "../../redux/features/Agreement/Agreement";
...
const EditUserAgreement = () => {
  const { data } = useGetAllUserAgreementQuery();
  const [updatePrivacyPolicy] = useUpdateUserAgreementMutation();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (result) {
        message.success("user agreement updated successfully!");
