...
const stripHtmlTags = (html) => {
  ...
  div.innerHTML = html || ""; // Handle null/undefined
  return div.textContent || div.innerText || "";
};

const EditTermsConditions = () => {
  const { data } = useGetAllTermConditionQuery();
  const [updateTermsConditions] = useUpdateTermConditionMutation();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const result = await updateTermsConditions(updatedContent);
