    ...
    <div className="w-full flex justify-center ">
      ...
      >
        <Button
          ...
          htmlType="submit"
          loading={loading}
          className="w-full bg-[#48B1DB] px-5 py-2 flex justify-center items-center gap-5 text-white rounded-md border-none"
          size="large"
          style={{
            display: "flex",
            alignItems: "center",
          ...
          onMouseEnter={(e) => {
            e.target.style.backgroundColor = "#48B1DB"; // Maintain the same background color on hover
            e.target.style.color = "#ffffff"; // Maintain white text color on hover
          }}
          onMouseLeave={(e) => {
            e.target.style.backgroundColor = "#48B1DB"; // Maintain the same background color when hover ends
